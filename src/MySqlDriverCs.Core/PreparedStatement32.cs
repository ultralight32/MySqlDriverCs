...
{
    internal class PreparedStatement32:PreparedStatementBase, IDisposable
    {
        MYSQL_BIND_32[] m_bindparms;

        internal PreparedStatement32(MySQLConnection connection, string query):base(connection)
        {
        ...
        public override void BindParameters()
        {
            ...
            int code = stmt.mysql_stmt_bind_param32(m_bindparms);
            if (code != 0)
