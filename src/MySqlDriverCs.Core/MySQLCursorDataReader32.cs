...
namespace MySQLDriverCS
{
    ...
    /// 
    /// </summary>
    public class MySqlCursorDataReader32 : MySqlCursorDataReaderBase
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        internal MySqlCursorDataReader32(uint fieldCount, NativeStatement stmt, MySQLParameterCollection parameters, MySQLConnection _connection, Statement _stmt, bool CloseConnection):base(_connection,stmt)
        {
            ...
            sbyte code = stmt.mysql_stmt_bind_result32(m_row);
            if (code != 0)
