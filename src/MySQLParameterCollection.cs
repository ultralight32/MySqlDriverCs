...
namespace MySQLDriverCS
{
	...
	/// 
	/// </summary>
	public sealed class MySQLParameterCollection2 : ArrayList, IDataParameterCollection
	{
		private bool sorted;
		...
		public ArrayList SortedList
		{
			get
			{
				if (!sorted)
				{
					sortedList = (ArrayList)this.Clone();
					sortedList.Sort(new MySQLParameterComparer());
					sorted = true;
				}
				return sortedList;
			}
